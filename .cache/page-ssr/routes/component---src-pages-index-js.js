...
var layout = __webpack_require__(4877);
...
// EXTERNAL MODULE: ./src/data/variables.js
var variables = __webpack_require__(6421);
;// CONCATENATED MODULE: ./src/components/about/style.js
const AboutSection=styled_components_esm["default"].section.withConfig({displayName:"style__AboutSection",componentId:"sc-1fwpqj7-0"})(["position:relative;text-align:center;@media only screen and (min-width:","){display:grid;grid-template-columns:1fr 1.25fr;grid-gap:10rem;text-align:left;}"],variables/* default.breakpointLarge */.Z.breakpointLarge);const Avatar=(0,styled_components_esm["default"])(gatsby_image/* default */.Z).withConfig({displayName:"style__Avatar",componentId:"sc-1fwpqj7-1"})(["border-radius:5px;box-shadow:0px 0px 64px rgba(0,0,0,0.15);width:100%;"]);const Title=styled_components_esm["default"].h1.withConfig({displayName:"style__Title",componentId:"sc-1fwpqj7-2"})(["margin:3rem 0 0 0;font-size:3rem;font-family:\"GT-Walsheim-Pro-Bold\";@media(max-width:","){font-size:2rem;}"],variables/* default.breakpointPhone */.Z.breakpointPhone);const Text=styled_components_esm["default"].p.withConfig({displayName:"style__Text",componentId:"sc-1fwpqj7-3"})(["font-size:1.2rem;line-height:2;color:#232323;a{color:#3F51B5;text-decoration:underline;}"]);const SubTitle=styled_components_esm["default"].h2.withConfig({displayName:"style__SubTitle",componentId:"sc-1fwpqj7-4"})(["font-family:\"GT-Walsheim-Pro-Medium\";word-spacing:8px;@media(min-width:","){font-size:1.8em;}"],variables/* default.breakpointPhone */.Z.breakpointPhone);
// EXTERNAL MODULE: ./src/components/common/index.js + 8 modules
var common = __webpack_require__(2730);
// EXTERNAL MODULE: ./node_modules/prop-types/index.js
var prop_types = __webpack_require__(5697);
...
var ChevronsDown = (0,index_js_.forwardRef)(function (_ref, ref) {
  var _ref$color = _ref.color,
      color = _ref$color === void 0 ? 'currentColor' : _ref$color,
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 24 : _ref$size,
  ...
  return /*#__PURE__*/index_js_default().createElement("svg", _extends({
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round"
  }, rest), /*#__PURE__*/index_js_default().createElement("polyline", {
...
/* harmony default export */ const chevrons_down = (ChevronsDown);
;// CONCATENATED MODULE: ./src/components/about/index.jsx
const greetings=["Hi","Hey","Howdy","Hello","Hiya"];const greeting=greetings[Math.floor(Math.random()*greetings.length)];const emojis=["✨","💫","🌈","☀️","🌱"];const emoji=emojis[Math.floor(Math.random()*emojis.length)];const About=()=>{return/*#__PURE__*/index_js_default().createElement("div",{style:{display:"table-cell",verticalAlign:"middle"}},/*#__PURE__*/index_js_default().createElement(common/* ContainerLayout */.rm,null,/*#__PURE__*/index_js_default().createElement(Title,null,greeting,", I\u2019m Lacey! ",/*#__PURE__*/index_js_default().createElement("span",{role:"img"},emoji)),/*#__PURE__*/index_js_default().createElement(Text,null,"My pronouns are ",/*#__PURE__*/index_js_default().createElement("i",null,"she/they"),". I am currently working as a Software Engineer at"," ",/*#__PURE__*/index_js_default().createElement("a",{href:"https://arete.com"},/*#__PURE__*/index_js_default().createElement("b",{className:"text-primary lined-link"},"Aret\xE9")),". I graduated from the University of California, San Diego in December 2020 with a B.S. in Computer Science.",/*#__PURE__*/index_js_default().createElement("br",null),"I have experience in web, mobile, and game development, and I enjoy creating projects both on my own and with others at"," ",/*#__PURE__*/index_js_default().createElement("a",{href:"https://devpost.com/lumamoto"},/*#__PURE__*/index_js_default().createElement("b",{className:"text-primary lined-link"},"hackathons")),". In my free time, I love working on fun side projects, learning new technologies, playing video games, cooking dubious vegan food, and listening to funky music.",/*#__PURE__*/index_js_default().createElement("br",null)),/*#__PURE__*/index_js_default().createElement(common/* ButtonDefault */.t,{href:"Lacey-Umamoto-Resume.pdf"},"Resume")),/*#__PURE__*/index_js_default().createElement("div",{style:{color:variables/* default.primary */.Z.primary,margin:`5rem 0 0 0`,textAlign:"center"}},/*#__PURE__*/index_js_default().createElement(chevrons_down// onClick = {() =>scrollEffect(projectsRef)}
,{className:"align-middle"})));};/* harmony default export */ const about = (About);
...
;// CONCATENATED MODULE: ./src/components/projects/index.jsx
const Projects=({data})=>{const projects=data.allMarkdownRemark.edges;return/*#__PURE__*/index_js_default().createElement(common/* ContainerLayout */.rm,null,/*#__PURE__*/index_js_default().createElement(common/* BigTitle */.K9,{className:"text-dark"},"Projects"),/*#__PURE__*/index_js_default().createElement(common/* ProjectGrid */.JC,null,projects.map(({node})=>{const title=node.frontmatter.title;// const title = node.frontmatter.title || node.fields.slug
return/*#__PURE__*/index_js_default().createElement(common/* ProjectPost */.$B,{key:node.frontmatter.github},/*#__PURE__*/index_js_default().createElement("div",{className:"media"},/*#__PURE__*/index_js_default().createElement("div",{className:"image-wrapper"},/*#__PURE__*/index_js_default().createElement("a",{href:node.frontmatter.github},node.frontmatter.image&&/*#__PURE__*/index_js_default().createElement(Y,{image:node.frontmatter.image.childImageSharp.gatsbyImageData})))),/*#__PURE__*/index_js_default().createElement("div",{className:"content"},/*#__PURE__*/index_js_default().createElement("header",null,/*#__PURE__*/index_js_default().createElement(common/* Category */.WD,null,node.frontmatter.category),/*#__PURE__*/index_js_default().createElement(common/* Title */.Dx,{className:"text-primary"},/*#__PURE__*/index_js_default().createElement("a",{// className="text-primary"
className:"text-primary lined-link",style:{boxShadow:`none`},href:node.frontmatter.github},title))),/*#__PURE__*/index_js_default().createElement(common/* Text */.xv,{dangerouslySetInnerHTML:{__html:node.frontmatter.description||node.excerpt}}),/*#__PURE__*/index_js_default().createElement("div",null,node.frontmatter.tags.map((tag,index)=>/*#__PURE__*/index_js_default().createElement(common/* Tag */.Vp,{key:index},tag)))));})));};/* harmony default export */ const projects = (Projects);
;// CONCATENATED MODULE: ./src/pages/index.js
const Index=({data})=>{return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement("div",{style:{height:"100vh",display:"table"}},/*#__PURE__*/index_js_default().createElement(about,null)),/*#__PURE__*/index_js_default().createElement(projects,{data:data}));};/* harmony default export */ const pages = (Index);const pageQuery="3396397131";
